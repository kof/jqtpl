...
exports.tag = {
    partial: {
        ...
        open: 'if(__notnull_1){__body=__body.concat(__jqtpl.partial(__1,__2,__data));}'
    },
    each: {
        default: {__2: '$value, $index'},
        open: 'if(__notnull_1){__jqtpl.each(__1a,function(__2){with(this){',
        close: '}});}'
    },
    verbatim: {},
    ...
    html: {
        open: 'if(__notnull_1){__body.push(__1a);}'
    },
    'if': {
    ...
    '=': {
        default: {__1: '__data'},
        open: 'if(__notnull_1){__body.push(__jqtpl.escapeHtml(__1a));}'
    },
...
exports.compile = function(markup, name) {
    ...
    if (!fn) {
        ...
        try {
            fn = exports.cache[name] = build(markup);
        } catch(err) {
            err.message += ': ' + name;
            err.markup = markup;
            throw err;
...
exports.render = function(markup, data) {
    ...
    if (data && isArray(data)) {
        ...
        for (i = 0; i < data.length; ++i) {
            ret += fn.call({}, exports, data[i]);
        }
    } else {
        ret = fn.call({}, exports, data || {});
    }
 ...
 */
exports.partial = exports.render;
