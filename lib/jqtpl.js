...
exports.tag = {
    partial: {
        ...
        open: 'if(__notnull_1){__+=$.partial($1,$2,$data)}'
    },
    each: {
        default: {$2: '$value,$index'},
        open: 'if(__notnull_1){$.each($1a,function($2){',
        close: '});}'
    },

    // Uncoded expression evaluation.
    html: {
        open: 'if(__notnull_1){__+=$1a}'
    },
    'if': {
        open: 'if((__notnull_1) && $1a){',
        close: '}'
    },
    'else': {
        default: {$1: true},
        open: '}else if((__notnull_1) && $1a){'
    },

    // Encoded expression evaluation. Abbreviated form is ${}.
    '=': {
        default: {$1: '$data'},
        open: 'if(__notnull_1){__+=$.escapeHtml($1a)}'
    },
